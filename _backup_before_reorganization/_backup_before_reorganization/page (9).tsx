...
export default async function InvitationPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  // The QR code on the public page also contains the short 6-char code
  // (consistent with the downloaded PDF/JPG version).
  ...
  return (
    <main className="relative flex min-h-screen flex-col bg-background paper-texture">
      ...
      <div className="mx-auto w-full max-w-4xl flex-1 px-4 py-10">
        ...
        {/* ===== INVITATION CARD ===== */}
        <div className="relative overflow-hidden rounded-3xl border-2 border-gold/40 bg-gradient-to-br from-card to-ivory/40 shadow-xl">
          {/* Inner border */}
