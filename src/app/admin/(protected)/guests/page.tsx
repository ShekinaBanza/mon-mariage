                  ...
                  <td className="px-3 py-2.5 text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-52">
                        ...
                        <DropdownMenuItem onClick={() => setConfirm({ type: "delete", guest: g })} className="text-destructive"><Trash2 className="mr-2 h-4 w-4" /> Supprimer définitivement</DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                  </td>
                </tr>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="font-display text-lg text-sage-deep">
              {confirm?.type === "delete" ? "Supprimer définitivement l'invité ?" : confirm?.type === "cancel" ? "Annuler l'invitation ?" : "Refuser l'invitation ?"}
            </DialogTitle>
          </DialogHeader>
          <p className="text-sm text-muted-foreground">
            {confirm?.type === "delete"
              ? `Cette action supprimera définitivement ${confirm?.guest.displayName}, son invitation, ses fichiers et libérera ses places.`
              : confirm?.type === "cancel"
